...
function crtajLiniju(e) {
    ...
    if (rect.y + rect.x <= 200) {
        // nista

    } else if (rect.x >= 250 && rect.y <= 50 && rect.x > rect.y) {
        // nista
    } else if (rect.x >= 300 && rect.y <= 100 && rect.x > rect.y) {
        // nista
    } else if (rect.x >= 350 && rect.y <= 150) {
        // nista
    } else if (rect.x >= 400 && rect.y <= 450) {
        // nista
    } else if (rect.x >= 250 && rect.y >= 350) {
        // nista
    } else if (rect.x >= 300 && rect.y >= 300) {
        // nista

    } else if (rect.x >= 350 && rect.y >= 250) {
        // nista
    } else if (rect.x <= 50 && rect.y >= 250) {
        // nista
    } else if (rect.x <= 150 && rect.y >= 350) {
        // nista
    } else if (rect.x <= 200 && rect.y >= 400) {
        // nista
    } else if (rect.x <= 100 && rect.y >= 300) {
        // nista
    } else {
        // Desna
    ...
    provjeri_kraj()
    console.log(brojac_ukupnih)
    if (brojac_ukupnih == 13) {
...
function crtajCanvas() {
    ...
    for (let i = 0; i <= 3; i++) {
        if (lijeva_donja_uspravna_x <= 200 && lijeva_donja_uspravna_y <= 500) {
            ctx.beginPath()
        ...
        if (desna_donja_uspravna_x >= 250 && desna_donja_uspravna_y <= 350) {
            ctx.beginPath()
        ...
        if (desna_donja_vodoravna_x <= 450 && desna_donja_vodoravna_y >= 250) {
            ctx.beginPath()
        ...
        if (desna_gornja_uspravna_x <= 400 && desna_gornja_uspravna_y <= 200) {
            ctx.beginPath()
        ...
        if (desna_gornja_vodoravna_x <= 350 && desna_gornja_vodoravna_y <= 200) {
            ctx.beginPath()
        ...
        if (lijeva_gornja_vodoravna_x <= 200 && lijeva_gornja_vodoravna_y >= 50) {
            ctx.beginPath()
