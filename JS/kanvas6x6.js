...
function crtajLiniju(e) {
    ...
    if (rect.y + rect.x <= 300) {
        // nista 

    } else if (rect.x >= 350 && rect.y <= 50 && rect.x > rect.y) {
        // nista 
    } else if (rect.x >= 400 && rect.y <= 100 && rect.x > rect.y) {
        // nista 
    } else if (rect.x >= 450 && rect.y <= 150) {
        // nista 
    } else if (rect.x >= 500 && rect.y <= 200) {
        // nista
    } else if (rect.x >= 550 && rect.y <= 250) {
        // nista
    } else if (rect.x >= 600 && rect.y <= 600) {
        // nista 
    } else if (rect.x >= 300 && rect.y >= 600) {
        // nista 
    } else if (rect.x >= 350 && rect.y >= 550) {
        // nista 

    } else if (rect.x >= 400 && rect.y >= 500) {
        // nista 
    } else if (rect.x >= 450 && rect.y >= 450) {
        // nista
    } else if (rect.x >= 500 && rect.y >= 400) {
        // nista
    } else if (rect.x >= 550 && rect.y >= 350) {
        // nista
    } else if (rect.x <= 50 && rect.y >= 300) {
        // nista 
    } else if (rect.x <= 100 && rect.y >= 400) {
        // nista 
    } else if (rect.x <= 200 && rect.y >= 500) {
        // nista 
    } else if (rect.x <= 250 && rect.y >= 550) {
        // nista 
    } else if (rect.x <= 150 && rect.y >= 450) {
        // nista 
    } else {
...
function kraj() {
    ...
    if (igrac_1_score > igrac_2_score) {
        let igrac1 = document.getElementById("igrac_1").innerText;
        ...
        let igrac2 = document.getElementById("igrac_2").innerText;
        var pob = document.getElementById("pobjednik");
        pob.style = "padding-top:2%";
        pob.innerHTML = "Pobjednik je";
...
function crtajCanvas() {
    ...
    for (let i = 0; i <= 6; i++) {
        if (lijeva_donja_uspravna_x <= 350 && lijeva_donja_uspravna_y <= 550) {
            ctx.beginPath()
        ...
        if (lijeva_donja_vodoravna_x <= 300 && lijeva_donja_vodoravna_y <= 600) {
            ctx.beginPath()
        ...
        if (desna_donja_uspravna_x <= 550 && desna_donja_uspravna_y >= 300) {
            ctx.beginPath()
        ...
        if (desna_donja_vodoravna_x <= 550 && desna_donja_vodoravna_y >= 350) {
            ctx.beginPath()
        ...
        if (desna_gornja_uspravna_x <= 600 && desna_gornja_uspravna_y <= 300) {
            ctx.beginPath()
        ...
        if (desna_gornja_vodoravna_x <= 600 && desna_gornja_vodoravna_y <= 300) {
            ctx.beginPath()
        ...
        if (lijeva_gornja_vodoravna_x <= 300 && lijeva_gornja_vodoravna_y >= 50) {
            ctx.beginPath()
        ...
        if (lijeva_gornja_uspravna_x >= 50 && lijeva_gornja_uspravna_y <= 300) {
            ctx.beginPath()
